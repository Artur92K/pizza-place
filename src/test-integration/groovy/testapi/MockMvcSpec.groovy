...
import pl.kaczmarek.pizzaplace.PizzaPlaceApplication
import spock.lang.Specification

@ContextConfiguration
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = [PizzaPlaceApplication])
